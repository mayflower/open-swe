...
If you only use one source, keep the shared tools and remove the unused source-specific reply tools from `get_tools_for_source()`. If you don't need web fetching, remove `fetch_url`.
